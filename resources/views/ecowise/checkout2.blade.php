    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-10">
                    ...
                    <div class="card-body">
                        ...
                        <div class="summary d-flex align-items-center justify-content-between mt-3">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('img/p'.$product->image.'.jpg') }}" style="width: 60px;" class="me-3">
                                <div>
                                    <h6>{{$product->name}}</h6>
                                    <p style="margin:0 ;">
                                        @lang('ecowise.rp') {{ number_format($product->price, 0, ',', '.') }} ({{$quantity}} pcs)
                                    </p>
                                </div>
                            </div>
                            <div>
                                <h6>@lang('ecowise.rp') {{ number_format($product->price * $quantity, 0, ',', '.') }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-3">
                    <form action="{{route('place_order2', $product->id)}}" method="POST">
                        @csrf
